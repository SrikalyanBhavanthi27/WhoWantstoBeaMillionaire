...
public class Question5Activity extends AppCompatActivity {
    private int moneyEarned = 50000; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "1912";
        ...
        findViewById(R.id.confirmButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButton != null) {
                    ...
                    Toast.makeText(Question5Activity.this, "Please select an option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            startActivity(new Intent(Question5Activity.this, GameLostActivity.class));
            finish();
        }
    }
