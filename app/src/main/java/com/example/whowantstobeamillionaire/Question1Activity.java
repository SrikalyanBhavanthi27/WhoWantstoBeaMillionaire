...
public class Question1Activity extends AppCompatActivity {
    ...
    private int moneyEarned = 0; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "Sachin Tendulkar";
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            startActivity(new Intent(Question1Activity.this, GameLostActivity.class));
            finish();
        }
    }
}
