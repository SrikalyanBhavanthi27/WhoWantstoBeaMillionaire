...
public class Question10Activity extends AppCompatActivity {
    private int moneyEarned = 750000; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "Yen";
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            Toast.makeText(this, "Correct! You earned $10,000", Toast.LENGTH_SHORT).show();

            // Move to the next question
            startActivity(new Intent(Question10Activity.this, GameWonActivity.class));
            finish(); // Close this activity
        } else {
            // Show toast for wrong answer
            Toast.makeText(this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(Question10Activity.this, GameLostActivity.class));
            finish();
        }
    }
