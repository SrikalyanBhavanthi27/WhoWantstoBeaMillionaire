...
public class Question4Activity extends AppCompatActivity {
    private int moneyEarned = 20000; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "Vincent van Gogh";
        ...
        findViewById(R.id.confirmButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButton != null) {
                    ...
                    Toast.makeText(Question4Activity.this, "Please select an option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            startActivity(new Intent(Question4Activity.this, GameLostActivity.class));
            finish();
        }
    }
