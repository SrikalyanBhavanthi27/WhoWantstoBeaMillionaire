...
public class Question2Activity extends AppCompatActivity {
    private int moneyEarned = 1000; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "Mahatma Gandhi";
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            startActivity(new Intent(Question2Activity.this, GameLostActivity.class));
            finish();
        }
    }
}
