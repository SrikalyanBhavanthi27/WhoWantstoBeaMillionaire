...
public class Question3Activity extends AppCompatActivity {
    private int moneyEarned = 10000; // Starting amount of money earned

    private static final String CORRECT_ANSWER = "Canberra";
    ...
    private void checkAnswer(String selectedAnswer) {
        if (selectedAnswer.equals(CORRECT_ANSWER)) {
            ...
            startActivity(new Intent(Question3Activity.this, GameLostActivity.class));
            finish();
        }
    }
